...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/resonance.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/resonance)
...
```bash
php artisan vendor:publish --tag="resonance-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="resonance-views"
```

## Usage

```php
$resonance = new ArtisanBuild\Resonance();
echo $resonance->echoPhrase('Hello, Artisan Build!');
```
